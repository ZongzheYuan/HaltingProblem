module Universal.Proof.Intermediate.case9_helper where
...
env {Pd}{P}{C}{E₁}{E₂}{Cr}{St}{d₁} = Pd ∷ P ∷ C ∷ (d=? ∙ (E₁ ∙ E₂)) ∙ Cr ∷ St ∷ d₁ ∷ dnil ∷ dnil ∷ []
...
lemma3 : {Pd P C E₁ E₂ Cr St d₁ : D} → eval ((hd (var Cd)) =? doconsE) (env {Pd}{P}{C}{E₁}{E₂}{Cr}{St}{d₁}) ≡ dnil
lemma3 {Pd}{P}{C}{E₁}{E₂}{Cr}{St}{d₁} with equalD? (eval (hd (var Cd)) (env {Pd}{P}{C}{E₁}{E₂}{Cr}{St}{d₁})) (eval doconsE (env {Pd}{P}{C}{E₁}{E₂}{Cr}{St}{d₁}))
lemma3 | eq ()
lemma3 | neq x = refl
